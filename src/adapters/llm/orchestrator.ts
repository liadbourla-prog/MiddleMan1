...
const MANAGER_TOOLS: FunctionDeclaration[] = [
  ...
  },
  {
    ...
    description: "Change business configuration: hours, services, a service's calendar color, whether a service is a group class or a 1-on-1 appointment, booking policies, staff permissions, instructors/teaching staff, or cancel a customer booking. Use this when the manager wants to change what customers can book, when they can book, what services are offered, pricing, a service's Google Calendar color (e.g. 'make Yoga blue', 'color Pilates red'), whether a service is a group class or private 1-on-1 (e.g. 'Pilates is a group class for 8', 'switch physio to 1-on-1'), who has access, to add or manage instructors and their weekly hours (e.g. 'add Dana as a yoga instructor Mon/Wed 9–13', 'change Dana's hours', 'remove Dana'), or wants to cancel a specific booking. Pass the manager's exact instruction.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        instruction: {
