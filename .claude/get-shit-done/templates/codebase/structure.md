...
- Usage: Reference from command with `@/Users/liadbourla/Desktop/PA_4_Business/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/liadbourla/Desktop/PA_4_Business/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/liadbourla/Desktop/PA_4_Business/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
