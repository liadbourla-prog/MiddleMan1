...
- **Global scope**: `/Users/liadbourla/Desktop/PA_4_Business/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/liadbourla/Desktop/PA_4_Business/.claude/notes/`)
...
2. Glob `/Users/liadbourla/Desktop/PA_4_Business/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/liadbourla/Desktop/PA_4_Business/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/liadbourla/Desktop/PA_4_Business/.claude/notes/` — works in any directory
