...
```
Agent(
  prompt="Read /Users/liadbourla/Desktop/PA_4_Business/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/liadbourla/Desktop/PA_4_Business/.claude/get-shit-done/templates/VALIDATION.md`
