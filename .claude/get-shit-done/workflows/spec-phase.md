...
```bash
INIT=$(node "/Users/liadbourla/Desktop/PA_4_Business/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/liadbourla/Desktop/PA_4_Business/.claude/get-shit-done/templates/spec.md.
